...
Future<Response> _put(RequestContext context, Todo todo, String id) async {
  final dataSource = context.read<TodosDataSource>();
  final jsonData = context.request.json();
  final updatedTodo = Todo.fromJson(await jsonData as Map<String, dynamic>);
